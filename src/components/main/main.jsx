        ...
        <div className="contacts-container">
          ...
          <ul className="contacts-list">
            <li className="contacts-item contact">
              ...
              <img className="contact__pic" src="img/avatar.svg" alt="contact pic" width="100" height="100"/>
                <p className="contact__name">John Smith</p>
                <a className="contact__number" href="tel:555-555-5555">555-555-5555</a>
                <ul className="contact__buttons-list">
                  <li className="contact__buttons-item">
                    <button className="contact__button" name="edit">
                      <svg className="contact__button-pic" fill="#4a90e2" xmlns="http://www.w3.org/2000/svg"
                           viewBox="0 0 24 24"
                  ...
                  <li className="contact__buttons-item">
                    <button className="contact__button" name="delete">
                      <svg className="contact__button-pic" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                           width="64px"
                           height="64px">
                        <path fill="#E04F5F"
